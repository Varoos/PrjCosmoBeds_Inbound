...
using static PrjCosmoBeds_Inbound.ClsProperties;
    ...
    public class FocusService : IFocusService
    {
        ...
        public ClsSalesInvoice.SalesResponse CreateInvoice(ClsSalesInvoice.SalesInvoice objfocus, int ccode)
        {
            ...
            try
            {
                ...
                {
                    if (!IsNameExist(ccode, "mcore_Account", objfocus.Header.CustomerName, " "))
                    {
                ...
                //    "Date": 132514834,
                //"CustomerAC__Name": "Test re",
                //"DueDate": 132514834,
                //"Currency__Code": "EUR",
                //"ExchangeRate": 4.3942000000,
                //"Company Master__Code": "CBTD",
                //"Salesman__Name": "Web",
                //"Place of supply__Name": "Export",
                //"Jurisdiction__Name": "Dubai",
                //"Hotel Master__Name": "Rena Studios",
                //"Transaction Type__Name": "Web Booking",
                //"sNarration": "",
                //"ConfirmationNumber": "202230390030367DB13478A90098B414B1FAF54",
                //"HotelCity": "Lambi",
                //"HotelCountry": "GR"
                ...
                string url = "http://" + serverip + "/Focus8API/Transactions/Vouchers/Sales Invoice - Services";
        ...
        public ClsSalesInvoice.SalesResponse CreateReturn(ClsSalesInvoice.SalesInvoice objfocus, int ccode)
        {
            ...
            try
            {
                ...
                string err = "";
                sessionId = getsessionid(username, Password, companycode);
                string url = "http://" + serverip + "/Focus8API/Transactions/Vouchers/Sales Return - Services";
        ...
        public ClsSalesInvoice.SalesResponse CreatePurchase(ClsSalesInvoice.SalesInvoice objfocus, int ccode)
        {
            ...
            try
            {
                ...
                string err = "";
                sessionId = getsessionid(username, Password, companycode);
                string url = "http://" + serverip + "/Focus8API/Transactions/Vouchers/Purchase Voucher - Services";
        ...
        public ClsSalesInvoice.SalesResponse CreatePurchaseReturn(ClsSalesInvoice.SalesInvoice objfocus, int ccode)
        {
            ...
            try
            {
                ...
                string err = "";
                sessionId = getsessionid(username, Password, companycode);
                string url = "http://" + serverip + "/Focus8API/Transactions/Vouchers/Purchase Return - Services";
                Clsdata.LogFile(doctype, doctype + " url:" + url, writelog);
                string error = "";
                var response = Post(url, sContent, sessionId, ref error);
